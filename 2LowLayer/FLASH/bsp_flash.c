...
{	 
    ...
    //GPIOFB3,4,5初始化设置
    GPIO_InitStructure.GPIO_Pin = MR_SCK_PIN|MR_MISO_PIN|MR_MOSI_PIN;//PB3~5复用功能输出	
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF;//复用功能
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_DOWN;//下拉
    GPIO_Init(MR_PORT, &GPIO_InitStructure);//初始化

    GPIO_PinAFConfig(MR_PORT,MR_SCK_PINSource,GPIO_AF_SPI3); //PB3复用为 SPI3
    GPIO_PinAFConfig(MR_PORT,MR_MISO_PINSource,GPIO_AF_SPI3); //PB4复用为 SPI3
    GPIO_PinAFConfig(MR_PORT,MR_MOSI_PINSource,GPIO_AF_SPI3); //PB5复用为 SPI3
...
void bsp_Flash_Init( void )
{
    ...
    //GPIOB14
    GPIO_InitStructure.GPIO_Pin = MR_CS_PIN;//PC8
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//输出
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;//推挽输出
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;//100MHz
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;//
    GPIO_Init(MR_PORT_CS, &GPIO_InitStructure);//初始化
